...
pyrcmip_template$literature_reference <- c('https://gmd.copernicus.org/articles/8/939/2015/gmd-8-939-2015.pdf \n https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2018EF001082')

# Save the csv file. 
write.csv(x = pyrcmip_template, file = file.path(OUT_DIR, 'rcmip_model_metadata_hector.csv'))
